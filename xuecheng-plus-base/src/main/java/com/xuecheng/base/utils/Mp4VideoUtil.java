...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "/Users/gavin_guo/ffmpeg"; //ffmpeg的安装位置
    String video_path = "/Users/gavin_guo/Desktop/study-demo/backend/java/test-big-file/heart.avi";
    String mp4_name = "test.mp4";
    String mp4folder_path = "/Users/gavin_guo/Desktop/study-demo/backend/java/test-big-file/";
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String mp4_name = "test.mp4";
        //转换后mp4文件的路径
        String mp4_path = "/Users/gavin_guo/Desktop/study-demo/backend/java/test-big-file/";
        //创建工具类对象
